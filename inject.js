...
var ics = function(uidDomain, prodId) {
    ...
    return {
      ...
      'addEvent': function(subject, description, location, begin, stop, until) {
        ...
        var calendarEvent = [
          ...
          calendarEvent.splice(4, 0, "RRULE:FREQ=WEEKLY;WKST=SU;UNTIL="+until_string+";BYDAY="+daysOfWeek[start_date.getDay()]);//test manual insert
  ...
  //using expanded ics lib for debugging
...
for (let i = 0; i < allClasses.length; i++) {
    ...
    // console.log(untilDate.toISOString());
