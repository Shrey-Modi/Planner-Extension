...
for (let i = 0; i < allClasses.length; i++) {
    ...
    // var endDate =  date[3] + " " + date[4].substring(0,date[4].length-1) + " " + date[date.length - 1];
    ...
    repeat = {freq:"WEEKLY", count:1, byday:[day]};

    //add the events spaced out by the day of the week
    for (let j = 0; j < 15; j++) {
        cal.addEvent(className, description, startDate, endDate, repeat);
...
// button.innerHTML = "download ics file";
// button.href = "javascript:cal.download()";
